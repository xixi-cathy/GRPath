...
parser.add_argument("-datafolder", "--datafolder", type=str, default=os.getcwd()+ '/../demo_data')
parser.add_argument("-iters", "--iters", type=int, default="10")
parser.add_argument("-repeats", "--repeats", type=int, default="2")
parser.add_argument("-kernels", "--kernels", type=int, default="8")
args = parser.parse_args()

init_path = os.getcwd()+ '/../' + args.datafolder
iters = args.iters
...
for snp in gwas_snps:
    ...
    causal_variants_less = [key for key,value in variants_unlist.items() if value >= repeats]
